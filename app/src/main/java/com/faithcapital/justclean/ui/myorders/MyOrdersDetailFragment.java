...
import com.faithcapital.justclean.ui.myorders.adapters.MyOrdersDetailsAdapter;
...
public class MyOrdersDetailFragment extends BaseFragment implements MyOrdersMvpView {
    ...
    private ArrayList<Items> feedList;
    private String status;
    public static MyOrdersDetailFragment newInstance(ArrayList<Items> feedList,String status) {
        Bundle args = new Bundle();
        MyOrdersDetailFragment fragment = new MyOrdersDetailFragment();
        args.putParcelableArrayList("items_list",feedList);
    ...
    protected void setUp(View view) {
        ...
        feedList = getArguments().getParcelableArrayList("items_list");

        status = getArguments().getString("status");

        if(status.equalsIgnoreCase("complete")){
            tvOrderStatus.setBackgroundColor(getResources().getColor(R.color.light_green));
        }else if(status.equalsIgnoreCase("pending")){
            tvOrderStatus.setBackgroundColor(getResources().getColor(R.color.light_blue));
        }else{
            tvOrderStatus.setBackgroundColor(getResources().getColor(R.color.red_dark));
    ...
    public void setAdapter(List<MyOrdersList> myOrdersLists, ArrayList<Items>itemsArrayList) {
        itemsArrayList = this.feedList;
        rvList.setAdapter(new MyOrdersDetailsAdapter(getBaseActivity(), itemsArrayList));
    }
